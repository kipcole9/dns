defmodule ExDns.Message.Header do
  ...
  def decode(<<id::size(16), qr::size(1), oc::size(4), aa::size(1),
                      tc::size(1), rd::size(1), ra::size(1), 0::size(1),
                      ad::size(1), cd::size(1), rc::size(4), qc::size(16),
                      anc::size(16), auc::size(16), adc::size(16),
                      rest::binary>>) do

    header = %Message.Header{id: id, qr: qr, oc: oc, aa: aa, tc: tc, rd: rd,
                             ra: ra, ad: ad, cd: cd, rc: rc, qc: qc, anc: anc, auc: auc,
                             adc: adc}
  ...
  """
  def set_authoritative(%Message.Header{} = header) do
